...
const Support = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-green-600 to-red-600 text-white">
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {supportOptions.map((option, index) => (
              <div 
                key={index} 
                className={`${option.color} rounded-xl border p-6 transition-all duration-300 hover:shadow-lg hover:scale-[1.02]`}
              >
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-gray-700 font-medium truncate">{option.contact}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 font-medium">{option.hours}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="bg-gradient-to-r from-red-600 to-red-700 text-white rounded-2xl p-8 md:p-10 shadow-xl">
            <div className="max-w-3xl mx-auto">
              <div className="flex items-center justify-center mb-6">
                ...
                <h3 className="text-2xl md:text-3xl font-bold">Technical Emergencies</h3>
              </div>
              
              <p className="text-center text-lg mb-8 text-red-100">
                Immediate assistance for critical service interruptions
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-red-700/50 rounded-xl p-6">
                  <h4 className="text-xl font-bold mb-4">📞 Call Support</h4>
                  <p className="text-2xl font-bold mb-2">
                    {whatsapp.formatPhoneDisplay(contact.emergencyPhone || contact.supportPhone)}
                  </p>
                  <p className="text-red-200">Available 24 hours, 7 days a week</p>
                </div>
                ...
                <div className="bg-red-700/50 rounded-xl p-6">
                  ...
                  <a 
                    ...
                    className="inline-flex items-center justify-center bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 w-full"
                  >
        ...
        <div className="mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {faqs.map((faq, index) => (
              <div 
                key={index} 
                className="bg-white border border-gray-200 rounded-xl p-6 hover:border-green-300 transition-all duration-300"
              >
                <div className="flex items-start">
                  <span className={`inline-flex items-center justify-center w-8 h-8 rounded-full ${index % 2 === 0 ? 'bg-green-100 text-green-600' : 'bg-red-100 text-red-600'} mr-4`}>
                    {index + 1}
                  </span>
                  <div>
        ...
        <div className="mb-12 md:mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-gradient-to-br from-green-50 to-white border border-green-200 rounded-xl p-6 text-center">
              <div className="w-16 h-16 rounded-full bg-green-100 flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">📍</span>
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-3">Visit Our Offices</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-gradient-to-br from-red-50 to-white border border-red-200 rounded-xl p-6 text-center">
            ...
            <div className="bg-gradient-to-br from-red-50 to-white border border-red-200 rounded-xl p-6 text-center">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-block bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg transition-all duration-300 mb-3"
              >
                Start Chat
              </a>
              <p className="text-gray-600 text-sm">
        ...
        {/* Self-care Portal */}
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-8 md:p-10 text-white text-center">
          <div className="max-w-2xl mx-auto">
            <div className="w-20 h-20 rounded-full bg-white/20 flex items-center justify-center mx-auto mb-6">
              <span className="text-3xl">🔐</span>
            </div>
            <h2 className="text-3xl font-bold mb-4">Self-care Portal</h2>
            <p className="text-lg text-green-100 mb-8">
              Manage your account, bills, and service requests online with our self-care portal
            </p>
            <Link 
              to="/selfcare" 
              className="inline-flex items-center bg-white text-green-600 hover:bg-gray-100 font-bold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105"
            >
        ...
        <div className="mt-12 text-center">
          ...
          <Link 
            to="/contact" 
            className="inline-flex items-center bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105"
          >
            Contact Us Directly
            <span className="ml-2">→</span>
          </Link>
